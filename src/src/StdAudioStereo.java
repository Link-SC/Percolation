 ...
 *  real number between â€?1.0 and +1.0. The samples are played in real
...
*/
    ...
    /**
     * Writes one stereo sample (between â€?1.0 and +1.0) to standard audio.
    ...
    /**
     * Writes the array of stereo samples (between â€?1.0 and +1.0) to standard audio.
     * If a sample is outside the range, it will be clipped.
     *
     * @param  samples the array of samples to play
     * @throws IllegalArgumentException if any sample is {@code Double.NaN}
